   ...
   let a = new Request("./toc.json"); // retoma el archivo json para el menú
    ...
    fetch(a).then(e=>e.json()).then(e=>i = e).then(function() { // separar por campos los datos
        const e = i.DATOS[0].titulo_curso
          ...
          , a = window.location.href.split("https://campus.universidadisep.com/file.php/").pop().split("/CONTENIDOS")[0]
          , o = window.location.href.split("N-")[0];
        t.insertAdjacentHTML("afterbegin", `\n      <button id="gi-nav-sec__boton" aria-label="Abrir índice de contenido"><svg focusable="false" viewBox="0 0 24 24" width="100%" height="100%"><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path></svg></button>\n      <nav aria-label="Índice de contenido" id="gi-nav-sec" class="gi-nav-sec">\n        <ul role="menubar" aria-label="Índice de contenido" class="gi-nav-sec__menu">\n            <li class="gi-nav-sec__cabecera" role="heading" aria-level="1">\n              <a href="N-1.html" title="Ir al inicio de la unidad" aria-label="Ir al inicio de la unidad" class="gi-nav-sec__titulo">${n}</a>\n            </li>\n            <li class="gi-nav-sec__filtro">\n              <label class="gi-filtro__etiqueta" for="gi-nav-sec__filtro">\n                <span class="gi-filtro__texto">Filtro</span>\n                <input type="text" id="gi-nav-sec__filtro"\n                name="q" maxlength="32" autocomplete="on" class="gi-filtro__motor" aria-label="Buscar en índice" placeholder="Buscar en índice...">\n              </label>\n            </li>\n            <li class="gi-nav-sec__opciones">\n              <button class="gi-btn-cat-1 gi-nav-sec__contenidos" aria-haspopup="true"\n                aria-expanded="true"><span>Contenidos</span></button>\n              <ol id="gi-nav-sec__arbol-contenidos" class="gi-menu-list" aria-label="Árbol de contenidos" role="menu" open>\n                \n              </ol>\n        \x3c!-- <button class="gi-btn-cat-1 gi-nav-sec__recursos" aria-haspopup="true"\n              aria-expanded="false"><span>Recursos</span></button>\n              <ul class="gi-nav-sec__recursos"></ul> --\x3e\n              <button class="gi-btn-cat-1 gi-nav-sec__preferencias" aria-haspopup="true"\n                aria-expanded="false"><span>Preferencias</span></button>\n              <ul class="gi-nav-sec__preferencias-lista">\n                <li class="modo-color">\n                  <span>Alto contraste:</span>\n                  <label class="gi-btn-switch">\n                    <input type="checkbox" id="adaptador-cromatico">\n                    <span class="gi-boton-configuracion" aria-hidden="true"></span>\n                  </label>\n                </li>\n                <li class="modo-datos">\n                  <span>Ahorro de datos:</span>\n                  <label class="gi-btn-switch">\n                    <input type="checkbox" id="ahorro-datos">\n                    <i class="gi-boton-configuracion__datos" aria-hidden="true"></i>\n                  </label>\n                </li>\n                <li class="modo-conexion">\n                  <span>Sin conexión:</span>\n                  <label class="gi-btn-switch">\n                    <input type="checkbox" id="sin-conexion">\n                    <i class="gi-boton-configuracion__conexion" aria-hidden="true"></i>\n                  </label>\n                </li>\n              </ul>\n              <button class="gi-btn-cat-1 gi-nav-sec__notas" aria-haspopup="true"\n                aria-expanded="false" aria-controls="gi-submenu-list"><span>Notas</span></button>\n                <ul class="gi-nav-sec__notas-lista">\n                </ul>\n              <button class="gi-btn-cat-1 gi-nav-sec__imprimir" aria-haspopup="true" aria-expanded="false"\n                aria-controls="gi-submenu-list" onclick="window.print();"><span>Imprimir</span></button>\n            </li>\n            <li class="gi-nav-sec__regresar"><a href="https://campus.universidadisep.com/course/view.php?id=${a}" class="gi-boton-regreso" title="Regresar a Campus"><span>Regresar a Campus</span></a></li>\n          </ul>\n        </nav>\n      `),
